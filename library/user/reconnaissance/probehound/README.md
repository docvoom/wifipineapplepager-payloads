...
Detected results are stored in the **loot/probehound** directory as a text file ("DATE-scanlog.txt"). Log files are designed to keep each day's scans in one file (same day, same file).
